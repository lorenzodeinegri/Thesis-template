...
\usepackage{colortbl}										% colorazione tabelle
...
\usepackage{float}											% posizionamento di immagini e tabelle
...
\usepackage[table, x11names, dvipsnames, table]{xcolor}		% colori
...
%\input{capitoli/capitolo-3}             					% Blockchain
\input{capitoli/capitolo-4}             					% Tecnologie e strumenti
\input{capitoli/capitolo-5}             					% Applicazione
